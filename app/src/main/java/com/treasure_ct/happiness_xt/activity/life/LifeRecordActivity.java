...
public class LifeRecordActivity extends BaseActivity implements View.OnClickListener, TextWatcher {
    ...
    private void sendDynamic() {
        ...
        dynamicBean.save(new SaveListener<String>() {
            ...
            public void done(String s, BmobException e) {
                if (e == null) {
                    Toast.makeText(LifeRecordActivity.this, "恭喜你，发表成功", Toast.LENGTH_SHORT).show();
                    //发送登录成功 广播
                    ...
                    Toast.makeText(LifeRecordActivity.this, "很遗憾，发表失败\n原因：" + e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }

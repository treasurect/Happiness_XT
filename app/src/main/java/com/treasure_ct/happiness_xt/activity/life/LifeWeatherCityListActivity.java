...
public class LifeWeatherCityListActivity extends BaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
                ...
                case 201:
                    ...
                    for (int i = 0; i < mResult.size(); i++) {
                        if (mResult.get(i).getProvince().equals(province)){
                            List<LifeWeatherCityListBean.ResultBean.CityBean> cityBeanList = mResult.get(i).getCity();
                        ...
                        if (mResult.get(i).getProvince().equals(province)){
                            ...
                            for (int j = 0; j < cityBeanList.size(); j++) {
                                if (cityBeanList.get(j).getCity().equals(city)){
                                    List<LifeWeatherCityListBean.ResultBean.CityBean.DistrictBean> districtBeen = cityBeanList.get(j).getDistrict();
    ...
    private List<LifeWeatherCityListBean.ResultBean> mResult;
    private LifeWeatherCityListBean cityListBean;
    ...
    private void getCityList() {
        ...
        Request request = new Request.Builder()
                .get()
                .url(StringContents.MobAPI_BaseUrl + "/v1/weather/citys?key=" + StringContents.MobAPI_APPKEY)
                .build();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        switch (parent.getId()) {
            ...
            case R.id.weather_cityList_district_listView:
                ...
                LifeWeatherCityListActivity.this.finish();
                break;
        }
    }

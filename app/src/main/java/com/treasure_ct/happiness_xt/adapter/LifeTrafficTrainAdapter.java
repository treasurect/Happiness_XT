...
public class LifeTrafficTrainAdapter extends BaseAdapter {
    private Context context;
    private List<LifeTrafficTrainBean.ResultBean> list;
    private LayoutInflater inflater;

    public LifeTrafficTrainAdapter(Context context, List<LifeTrafficTrainBean.ResultBean> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view != null) {
            ...
            ret = inflater.inflate(R.layout.traffic_train_list_item, viewGroup, false);
        }
        ret.setTag(new ViewHolder(ret));
        LifeTrafficTrainBean.ResultBean resultBean = list.get(i);

...
public class LifeGridAdapter extends BaseAdapter {
    ...
    private List<LifeGridBean> list;
    private LayoutInflater inflater;

    public LifeGridAdapter(Context context, List<LifeGridBean> list) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (view != null) {
            ...
            ret = inflater.inflate(R.layout.life_grid_item, viewGroup, false);
        }
        ret.setTag(new ViewHolder(ret));
        final LifeGridBean gridBean = list.get(position);

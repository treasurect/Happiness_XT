...
public class AssistantWeatherFutureAdapter extends BaseAdapter{
    private Context mContext;
    private List<AssistantWeatherFutureBean> list;
    private LayoutInflater mInflater;

    public AssistantWeatherFutureAdapter(Context context, List<AssistantWeatherFutureBean> list) {
        mContext = context;
        this.list = list;
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (view != null){
            ...
            ret = mInflater.inflate(R.layout.assistant_weather_future_item,viewGroup,false);
        }
        ret.setTag(new ViewHolder(ret));
        AssistantWeatherFutureBean futureBean = list.get(position);

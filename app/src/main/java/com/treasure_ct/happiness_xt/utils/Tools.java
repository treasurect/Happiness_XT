...
import com.treasure_ct.happiness_xt.manager.SystemBarTintManager;
...
public class Tools{
	...
	public static void setTranslucentStatus(Activity context) {
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
			...
			tintManager.setStatusBarTintResource(R.color.title_background_green);// 状态栏无背景
	}
	...
	public static Dialog createDialog(Context context,View mainView,int width,boolean cancel){
		Dialog customDialog = new Dialog(context, R.style.dialog);
		...
		customDialog.setCanceledOnTouchOutside(cancel);
